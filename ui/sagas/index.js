...
import { REMOVE_DEPENDENCY, ADD_DEPENDENCY } from '../ducks/dependencies';
import { removeDependency, addDependency } from './dependencies';
...
export default function* index() {
  ...
  yield takeLatest(ADD_DEPENDENCY, addDependency);
}
